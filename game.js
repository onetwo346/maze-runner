...
<body>
    ...
    <script>
        ...
        if (typeof THREE === 'undefined') {
            ...
            alert('Three.js didn’t load. Check internet or use a server.');
        ...
        document.addEventListener('touchmove', (e) => {
            if (joystickActive) {
                e.preventDefault();
                const touch = Array.from(e.touches).find(t => t.target === joystick || t.target === knob);
                if (touch) updateJoystick(touch);
            }
        }, { passive: false });

        document.addEventListener('touchend', (e) => {
            if (joystickActive && Array.from(e.touches).length === 0) {
        ...
        function updateJoystick(touch) {
            ...
            console.log(`Joystick: X=${joystickX.toFixed(2)}, Y=${joystickY.toFixed(2)}`);
        }
        ...
        function animate() {
            ...
            if (joystickActive) {
                ...
                player.angle -= joystickX * player.turnSpeed * 1.5;
            }
